...
export default createTypes(
  `
    ...
    PUT_PRODUCT_ORDER_DETAIL
    PUT_PRODUCT_ORDER_DETAIL_SUCCESS
    PUT_PRODUCT_ORDER_DETAIL_FAILURE

    PUT_PRODUCT_ORDER_FULFILLMENT
    PUT_PRODUCT_ORDER_FULFILLMENT_SUCCESS
    PUT_PRODUCT_ORDER_FULFILLMENT_FAILURE
